...
contract VotingSistemV2 is Regist, CanditContract {
    ...
    function election(uint _votePresident, uint _voteGorvernor, uint _voteMayor) public timeVote() regist() validVotes(_votePresident,_voteGorvernor,_voteMayor) canditVoteFor(_votePresident,_voteGorvernor,_voteMayor){
